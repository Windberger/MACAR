    ...
    return (
        <div className="flex justify-center h-full">
            <div className="overflow-x-auto w-full">
                <table className="w-full h-full table-fixed border-t-2 border-l-2 border-r-2 border-b-2 border-black dark:border-gray-400">
                    <thead>
                        ...
                        {days.map((day, index) => {
                            ...
                            return (
                                <th key={day} className="px-2 py-2 text-center w-[8%]">
                                    <div>{day}</div>
                                    <div className="text-sm">{date.toLocaleDateString("en-GB", { day: "2-digit", month: "2-digit" })}</div>
                                </th>
                            );
                        })}
                    </tr>
