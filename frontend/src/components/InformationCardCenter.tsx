...
function InformationCardCenter({ title, description, left, className }: IInformationCard) {
    const styleHeader = "text-black mt-5 text-center";
...
export default InformationCardCenter;