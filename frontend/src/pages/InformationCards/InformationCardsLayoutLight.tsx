...
function InformationCardsLayoutLight() {
    ...
    return (
        <div className="flex flex-col items-center h-auto bg-white space-y-10" id="wash-detailing">
            <div
                className="flex flex-col sm:flex-row md:flex-col justify-center items-center bg-white w-full sm:w-4/5 md:w-full space-y-5 sm:space-y-0 md:space-y-5 sm:space-x-10 md:space-x-0 p-5 z-10 mt-12 rounded-none sm:rounded-xl shadow-lg">
            ...
            <div
                className="flex flex-col sm:flex-row md:flex-col justify-center items-center bg-white w-full sm:w-4/5 md:w-full space-y-5 sm:space-y-0 md:space-y-5 sm:space-x-10 md:space-x-0 p-5 z-10 rounded-none sm:rounded-xl shadow-lg"
                id="mechanic">
